...
var lyricsData = [
  ...
  { text: "son estas manos santas, las manos de mi madre,", time: 46 },
  { text: "aquellas que me dieron con todo amor el pan.", time: 52 },
  { text: "Las manos que yo quiero, las manos de mi madre,", time: 58 },
  { text: "ligeras como aves, volando siempre van;", time: 63 },
  { text: "las manos de mi madre, vorágines dichosas,", time: 70 },
  { text: "si no hacen siempre algo, tranquilas nunca están.", time: 75 },
  { text: "Por rústicas y viejas, ¡qué bellas son sus manos!", time: 81 },
  { text: "Lavando tanta ropa, cortando tanto pan,", time: 87 },
  { text: "corriendo por la casa, la mesa acariciando,", time: 93 },
  { text: "buscando en el descanso la aguja y el dedal.", time: 99 },
  { text: "Las manos que trajeron la lámpara a mi cama,", time: 115 },
  { text: "tapándome la espalda en el invierno cruel,", time: 121 },
  { text: "que cuando estuve triste, mis lágrimas secaron,", time: 127 },
  { text: "que cuando estuve enferma, acariciaronme.", time: 133 },
  { text: "¡Oh, manos adoradas!, ¡oh, manos llenas de alma!,", time: 143 },
  { text: "en ellas hoy quisiera mi frente refugiar;", time: 152 },
  { text: "y tristemente digo: '¡Qué lejos que se encuentran!,", time: 158 },
  { text: "¡qué lejos de mi angustia y de mi soledad!'.", time: 169 }
];
